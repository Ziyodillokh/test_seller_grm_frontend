    ...
    <div className={`flex  gap-2.5 mx-4 mt-[17px]`}>
      <Link to={'/new-qr-code'} className="w-full  relative rounded-[22px] overflow-hidden flex items-end bg-card p-[15px] pt-[40px]">
        <img
          ...
          width={149}
          height={157}
          src={`${import.meta.env.BASE_URL}images/branding-stickers.png`}
          alt="qr-code"
        />
      ...
      <div className="w-full">
        <div className="flex gap-4 mb-4">
          ...
          >
            <img
              ...
              height={80}
              className="h-[80px]"
              src={`${import.meta.env.BASE_URL}images/qr_costom.png`}
            />
          </Link>
          <Link
            to={`/qr-code?type=qrcode&link=home`}
          ...
          >
            <img width={44} height={42} src={`${import.meta.env.BASE_URL}images/scaner.png`} />
          </Link>
        </div>
        <Link to={'/partiya'} className="rounded-[22px] inline-block relative w-full p-4 bg-card">
          ...
          <img className="absolute bottom-0 right-0" width={115} height={60} src={`${import.meta.env.BASE_URL}images/car-big.png`} />
          </Link>
        </div>
    </div>
  );
