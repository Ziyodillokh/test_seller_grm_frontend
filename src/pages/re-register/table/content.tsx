...
import { ProductsData } from "@/pages/hame/type";
// import FilterTabs from "@/pages/hame/ui/filter-tabs";

// import QrTabs from "../qr-tabs";
// import BronsModals from "../hame/ui/modals";
        ...
        {data &&
          data?.map((item) => (
            ...
            key={item?.id}
              ...
              type={type || "all"}
              count={
                (item?.bar_code?.isMetric && type == "остаток")
