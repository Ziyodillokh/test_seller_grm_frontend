...
export default function Waveform({ isRecording, stream }: WaveformProps) {
        ...
        <div
          ...
          style={{
            ...
            background: isRecording
              ...
              : "#E8E8E8",
            opacity: 0.25,
            transition: isRecording ? "height 0.08s ease, opacity 0.08s ease" : "height 0.4s ease, opacity 0.4s ease",
          }}
        />
      ))}
    </div>
